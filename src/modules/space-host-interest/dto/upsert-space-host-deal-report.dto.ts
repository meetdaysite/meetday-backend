...
export class UpsertSpaceHostDealReportDto {
  @ApiProperty({ example: 'Set up a branded booth at the entrance and ran 3 Instagram stories.' })
  @IsString()
  @MaxLength(4000)
  summary: string;

  @ApiPropertyOptional({ example: 'Community Meetup 2026' })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  projectName?: string;
  ...
  @ApiPropertyOptional({
    type: [String],
    description: 'Up to 6 GCS object keys from POST /storage/upload-url (SPACE_HOST_DEAL_REPORT_MEDIA context)',
  })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(6)
  ...
  @ApiPropertyOptional({ example: 'Footfall was higher than expected.' })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
  notes?: string;
