...
@Module({
  ...
  providers: [SponsorshipService, SponsorshipInvoicePdfService, SponsorshipReportPdfService, ProposalPdfGeneratorService, ProposalDeckContentService, ProposalCopilotService, UnreadChatMailProcessor, SponsorshipChatGateway],
