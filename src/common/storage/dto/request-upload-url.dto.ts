...
export enum UploadContext {
  ...
  SPACE_PROPOSAL_DOCUMENT = 'SPACE_PROPOSAL_DOCUMENT',
  SPONSORSHIP_CHAT_MEDIA = 'SPONSORSHIP_CHAT_MEDIA',
  SPACE_CHAT_MEDIA = 'SPACE_CHAT_MEDIA',
  SPACE_HOST_CHAT_MEDIA = 'SPACE_HOST_CHAT_MEDIA',
  MEETDAY_CHAT_MEDIA = 'MEETDAY_CHAT_MEDIA',
  COMMUNITY_PAST_EVENT_MEDIA = 'COMMUNITY_PAST_EVENT_MEDIA',
  SPONSORSHIP_DEAL_REPORT_MEDIA = 'SPONSORSHIP_DEAL_REPORT_MEDIA',
  SPACE_DEAL_REPORT_MEDIA = 'SPACE_DEAL_REPORT_MEDIA',
  SPACE_HOST_DEAL_REPORT_MEDIA = 'SPACE_HOST_DEAL_REPORT_MEDIA',
  COMMUNITY_BRAND_LOGO_MEDIA = 'COMMUNITY_BRAND_LOGO_MEDIA',
  ADMIN_ANNOUNCEMENT_ATTACHMENT = 'ADMIN_ANNOUNCEMENT_ATTACHMENT',
  COMMUNITY_COLLABORATION_CHAT_MEDIA = 'COMMUNITY_COLLABORATION_CHAT_MEDIA',
}
...
export class RequestUploadUrlDto {
  ...
  @ApiPropertyOptional({
    description:
      ...
      'Not used for USER_AVATAR / HOST_DOCUMENT / REVIEW_PHOTO / MEETDAY_CHAT_MEDIA.',
  })
  @IsOptional()
  @IsUUID()
  resourceId?: string;
