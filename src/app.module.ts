...
import { BrandCommunityCollaborationModule } from './modules/brand-community-collaboration/brand-community-collaboration.module';
...
@Module({
  imports: [
    ...
    BrandCommunityCollaborationModule,
