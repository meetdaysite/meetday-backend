...
-- CreateIndex
CREATE UNIQUE INDEX "community_collaboration_interests_requesterCommunityId_targ_key" ON "community_collaboration_interests"("requesterCommunityId", "targetCommunityId");
...
-- CreateIndex
CREATE INDEX "community_collaboration_messages_communityCollaborationId_c_idx" ON "community_collaboration_messages"("communityCollaborationId", "createdAt");
